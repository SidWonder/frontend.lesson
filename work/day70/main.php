            ...
            <div class="row align-items-center">
              <div class="col-12 col-lg-5">
                <div class="main-img hidden-mobile">
                  <img src="img/decor/main_box.png" alt="Картон" />
                </div>
              </div>
        ...
        <div class="main main-bg2">
          <div class="container">
            <div class="row align-items-center">
              <div class="col-12 col-lg-5">
                <div class="main-img hidden-mobile">
                  <img src="img/decor/main_box2.png" alt="Картон" />
                </div>
              </div>
              <div class="col-12 col-lg-7">
                <div class="main-text">
...
"
    ...
    <section class="individual">
      <div class="container">
        ...
        <form action="telegram.php" class="ind-form" method='POST'>
          <input
        ...
        <div class="row">
          <div class="col-12 col-lg-7 order-last order-lg-first">
            <div class="manufacturing-slider_top hidden-mobile">
              <img src="img/decor/man_1.jpg" alt="" />
              <img src="img/decor/man_2.jpg" alt="" />
              <img src="img/decor/man_3.jpg" alt="" />
              <img src="img/decor/man_4.jpg" alt="" />
              <img src="img/decor/man_5.jpg" alt="" />
              <img src="img/decor/man_6.jpg" alt="" />
            </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="client-box">
            ...
            <div class="client-box__item">
              <img
                src="img/decor/m3_silversnow.jpg"
                alt="silversnow"
                class="client-box__img"
              />
            </div>
            ...
            <div class="client-box__item">
              <img
                src="img/decor/m9_indushkin.jpg"
                alt="indushkin"
                class="client-box__img"
              />
            </div>
      ...
      <div class="container">
        ...
        <div class="feedback-slider">
          <div class="feedback-slider_item">
            <img src="img/decor/feedback_1.jpg" alt="" />
          </div>
          <div class="feedback-slider_item">
            <img src="img/decor/feedback_2.jpg" alt="" />
          </div>
          <div class="feedback-slider_item">
            <img src="img/decor/feedback_3.jpg" alt="" />
          </div>
          <div class="feedback-slider_item">
            <img src="img/decor/feedback_1.jpg" alt="" />
          </div>

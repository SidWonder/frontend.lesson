...
**Комментарий:**
Решил выбрать другой макет на первое время, тот который разбирается в курсах LS.
Некоторые старые наработки удаляю, начинаю заново.
Так-же планирую проходить курсы FreeCodeCamp.
...
***
#####  DAY 5:  [11.02.19]
Настроил Sublime Text, сделал распечатки по горячим клавишам. Немного подучил тэги. Код сегодня не писал.
